...
namespace NestNet.Cli.Generators
{
    internal static class DtosGenerator
    {
        ...
        private static DtosGenerationContext? CreateDtosGenerationContext(InputParams? inputParams = null)
        {
            ...
            var projectAssembly = LoadAssembly(currentDir, projectName);
            ...
            var modulesPath = Path.Combine(currentDir, "Modules");
            ...
            return new DtosGenerationContext(currentDir, projectName, relativeTarDir, modulesPath, projectAssembly);
        }
