...
namespace NestNet.Cli.Generators
{
    ...
    {
        private class ApiModuleGenerator : ModuleGeneratorBase
        {
            ...
            private void CreateControllerFile()
            {
                ...
                string controllerPath = Path.Combine(Context.ProjectContext!.ModulePath, "Controllers", $"{Context.PluralizedModuleName}Controller.cs");
            ...
            private void CreateControllerTestFile()
            {
                ...
                string testPath = Path.Combine(Context.ProjectContext!.ModulePath, "Tests", "Controllers", $"{Context.PluralizedModuleName}ControllerTests.cs");
